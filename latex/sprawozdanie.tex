...
\section{Podsumowanie}
	\subsection{Wnioski}
		...
		\item Zaproponowana heurystyka daje efekty porównywalne z~\emph{multirandom}.
		\item O~ile \emph{Local Search} sprawdza się dla wszystkich instancji, efektywność \emph{multirandom} zależy od konkretnego przypadku.
		\item W~żadnym przypadku nie znaleziono związku między jakością rozwiązania startowego a~końcowego.
		\item Podobieństwo częściowe rozwiązań znajdowanych przez dany algorytm na danej instancji jest podobne dla różnych algorytmów.
		\end{itemize}
